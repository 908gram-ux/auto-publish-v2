...
class PromptData {
     ...
     */
    public static function buildPrompts($keyword, $naver_data = [], $internal_links = [], $contentMin = 3000, $contentMax = 5000) {
...
[이미지 위치 표시]
- 본문 중간에 [IMAGE: 한글설명 | english_search_term] 형태로 2~3개 삽입
